...
#define GREEN_ON		HAL_GPIO_WritePin(LED_GRENN_GPIO_Port,LED_GRENN_Pin,GPIO_PIN_RESET)
...
#define GREEN_OFF		HAL_GPIO_WritePin(LED_GRENN_GPIO_Port,LED_GRENN_Pin,GPIO_PIN_SET)
